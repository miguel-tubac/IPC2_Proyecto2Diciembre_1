...
urlpatterns = [
    ...
    path('clientes/editar_cliente/<str:nit>/', editar_cliente, name='editar_cliente'),
    path('guardar_cambios_cliente/<str:nit>/', guardar_cambios_cliente, name='guardar_cambios_cliente')
]
